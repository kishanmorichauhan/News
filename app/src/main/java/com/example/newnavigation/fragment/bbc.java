 ...
 * Use the {@link bbc#newInstance} factory method to
...
public class bbc extends Fragment {
     ...
     * @return A new instance of fragment bbc.
     */
    // TODO: Rename and change types and number of parameters
    public static bbc newInstance(String param1, String param2) {
        bbc fragment = new bbc();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        WebView webView = view.findViewById(R.id.wv_bbc);
